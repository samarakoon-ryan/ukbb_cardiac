...
tf.flags.DEFINE_integer('time_step', 1,
                            'Time step during deployment of LSTM.')
tf.flags.DEFINE_enum('seq_name', 'ao', ['ao'],
                         'Sequence name.')
tf.flags.DEFINE_enum('model', 'UNet-LSTM', ['UNet', 'UNet-LSTM', 'Temporal-UNet'],
                         'Model name.')
...
tf.flags.DEFINE_boolean('save_seg', True,
                            'Save segmentation.')
tf.flags.DEFINE_boolean('z_score', True,
                            'Normalise the image intensity to z-score. '
                            'Otherwise, rescale the intensity.')
tf.flags.DEFINE_integer('weight_R', 5,
                            'Radius of the weighting window.')
tf.flags.DEFINE_float('weight_r', 0.1,
